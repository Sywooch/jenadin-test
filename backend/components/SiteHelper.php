    ...
    public function buildMenu()
    {
        ...
        $menu_items = [
            ...
            ['label' => Module::t('Shop'), 'icon' => 'fa fa-product-hunt', 'url' => '#',
             'items' => [
                 ['label' => Module::t('Orders'), 'url' => ['/products/orders/index', 'sort' => '-id'], 'icon' => 'fa fa-circle'],
                 ['label' => Module::t('Sales'), 'url' => ['/products/sales/index'], 'icon' => 'fa fa-circle'],
                 ...
                 ['label' => Module::t('Kits'), 'url' => ['/products/kits/index'], 'icon' => 'fa fa-circle'],
                 ['label' => Module::t('Email templates'), 'url' => ['/products/email-templates/index'], 'icon' => 'fa fa-circle'],
                 ['label' => Module::t('Email setting'), 'url' => ['/products/email-settings/index'], 'icon' => 'fa fa-circle'],
             ]
            ],
            ['label' => Module::t('Content'), 'icon' => 'fa fa-navicon', 'url' => '#',
             'items' => [
                 ...
                 ['label' => Module::t('Novelties'), 'url' => ['/content/novelties/index'], 'icon' => 'fa fa-circle'],
                 ['label' => Module::t('Magazines'), 'url' => ['/content/magazines/index'], 'icon' => 'fa fa-circle'],
             ]
            ],
            ...
            ['label' => Module::t('Settings'), 'icon' => 'fa fa-cog', 'url' => '#',
             'items' => [
                 ...
                 ['label' => Module::t('Currency'), 'url' => ['/settings/currencies'], 'icon' => 'fa fa-euro'],
                 ['label' => Module::t('Social networks'), 'icon' => 'fa fa-vk', 'url' => ['/settings/social-links/index']],
                 ['label' => Module::t('Stocks'), 'icon' => 'fa fa-archive', 'url' => ['/settings/stocks/index']],
             ]
            ],
        ];
