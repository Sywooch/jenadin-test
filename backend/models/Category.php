...
class Category extends Bean
{
    ...
    public function rules()
    {
        ...
        return [
            [['created_at', 'updated_at', 'sort', 'parent_id', 'enabled'], 'integer'],
            [['alias', 'image'], 'string'],
    ...
    public function afterValidate()
    {
        ...
        if (isset($this->imageFile)) {
            $pathToFrontend = Yii::getAlias('@frontend') . '/web';
            $relativePath = '/uploads/categories/' . $this->id . '/';
            $path = $pathToFrontend . $relativePath;
            $baseName = SiteHelper::translit($this->imageFile->baseName);
            array_map('unlink', glob($path . '*'));
            BaseFileHelper::createDirectory($path);
            $this->imageFile->saveAs($path . $baseName . '.' . $this->imageFile->extension);
            $this->image = $relativePath . $baseName . '.' . $this->imageFile->extension;
        }
    }
