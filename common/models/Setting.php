...
class Setting extends Bean
{
    ...
    {
        $this->multiLanguageFields = ['table_size', 'seo_category_description'];
        parent::init();
    }
    ...
    public function rules()
    {
        ...
        $safe = ArrayHelper::merge($multiLanguageNames['table_size'], $multiLanguageNames['seo_category_description']);
        return [
            [['phone'], 'required'],
