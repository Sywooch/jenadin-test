...
<div>
    ...
    <div class="vc_row wpb_row vc_row-fluid">
        <div class="wpb_column vc_column_container vc_col-sm-3 profile-block-index">
        ...
        <div class="wpb_column vc_column_container vc_col-sm-3 profile-block-index">
            <a href="<?= FrontendHelper::formLink('/cabinet/account/favourite') ?>" class="profile-index-link">
                <h2><?= Module::t('Wish list') ?></h2>
                <p><?= Module::t('View your favourite products.') ?></p>
            </a>
        </div>
        <div class="wpb_column vc_column_container vc_col-sm-3 profile-block-index">
            <a href="<?= FrontendHelper::formLink('/cabinet/account/orders') ?>" class="profile-index-link">
                <h2><?= Module::t('Orders') ?></h2>
                <p><?= Module::t('View your order history.') ?></p>
            </a>
        </div>
    </div>
</div>
