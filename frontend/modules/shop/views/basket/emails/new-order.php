...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td valign="top" style="padding: 48px">
            <div id="body_content_inner" style="color: #737373;
                ...
                <h2 style="color: #4e7b94; display: block; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial,
                        sans-serif; font-size: 18px; font-weight: bold; line-height: 130%;
                        margin: 16px 0 8px; text-align: left;">
                    <a class="link"
                       href="<?= \yii\helpers\Url::to(['/admin/products/orders/view', 'id' => $order->id], true) ?>"
                       style="color: #4e7b94; font-weight: normal; text-decoration: underline;">
                ...
                <table class="td" cellspacing="0" cellpadding="6"
                    ...
                    <? foreach ($order->orderItems as $item): ?>
                        <tr class="order-item">
                            <td class="td" style="text-align: center; vertical-align: middle; border: 1px solid #eee;
                                font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;
                                word-wrap: break-word; color: #737373; padding: 12px;">
                            ...
                            <td class="td" style="text-align: left; vertical-align: middle; border: 1px solid #eee;
                                font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; color: #737373;
                                padding: 12px;">
                                <?= $item->count ?>
                            </td>
                            <td class="td" style="text-align: left; vertical-align: middle; border: 1px solid #eee;
                ...
                <h2 style="color: #4e7b94; display: block;
